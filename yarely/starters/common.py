...
python_platform_map = {
    "darwin": "python3.2",
    "linux2": "python3.2",
    "win32": "c:\\python32\\python.exe",
}

# Environment template for path to Python binary.
YARELY_PYTHON32_BIN_ENVIRONMENT_KEY = "YARELY_PYTHON32_BIN"
...
def get_python_binary(requirements):
    ...
    if YARELY_PYTHON32_BIN_ENVIRONMENT_KEY in os.environ:
        return os.environ[YARELY_PYTHON32_BIN_ENVIRONMENT_KEY]
