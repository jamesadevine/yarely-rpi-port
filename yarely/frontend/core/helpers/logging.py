...
class TimedRotatingFileHandlerWithApplicationName(TimedRotatingFileHandler):
    ...
    def __init__(self, filename, *args, **kwargs):
        ...
        usual_path_start_string = '_yarely_frontend_'
        index_of_usual_path_start_string = application_name.rfind(usual_path_start_string)
        if index_of_usual_path_start_string >= 0:
            application_name = application_name[index_of_usual_path_start_string+1:]
